      ...
      <body className=" dark:bg-slate-800 relative">
        <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ecommerce Website</span>
            </a>
        ...
        {/* <header>
          <nav className="p-8 bg-green-500 text-center">
            <div className="max-w-screen-xl flex-wrap text-xl space-x-20">
        ...
        <div className="m-4 p-2 text-3xl">
            <img src="./src/assets/images/testimage.jpg" className="text-4xl place-content-center size-auto object-contain rounded-full" alt="BIG PICTURE"/>
          </div>
